...
- If any variable or function names are unclear, ambiguous, or poorly chosen, provide alternative names that are more descriptive, precise, and aligned with their purposeo- Identify N+1 database query problems
